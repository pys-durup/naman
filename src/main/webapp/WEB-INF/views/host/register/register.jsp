...
<section>
    ...
    <form method="POST" action="/naman/host/registerok.action" enctype="multipart/form-data" id="formReg">
        ...
        <div class="box">
            <div class="withFloat subbox" style="width: 350px;">
                ...
                <input type="text" class="form-control" id="name" name="name" placeholder="숙소명" required>
            </div>
            <div class="withFloat subbox" style="width: 350px;">
        ...
        <div class="subbox" style="width: 750px;">
            ...
            <input type="text" class="form-control" id="webAddress" name="webAddress" placeholder="웹사이트주소" required>
        </div>
        ...
        <button type="submit" class="btn btn-primary btn" id="btnReg">등록하기</button>
